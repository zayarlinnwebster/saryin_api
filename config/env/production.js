 ...
 */
const { MYSQL_USERNAME, MYSQL_PASSWORD, MYSQL_DBNAME, MYSQL_HOST, MYSQL_PORT } = require('../local.js');
...
module.exports = {
  ...
  **************************************************************************/
  ssl: {
    ca: require('fs').readFileSync(require('path').resolve(__dirname, '../ssl/server.csr')),
